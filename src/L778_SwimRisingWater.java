...
/*
Translate the problem: every number in cell is the max time it needs to go through
So what we are looking for is a path on which the max number is global min

 */

import java.util.PriorityQueue;

public class L778_SwimRisingWater {
